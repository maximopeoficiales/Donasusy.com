  ...
  var v = {
      ...
      init: function () {
        g(document.body).bind("update_checkout", this.update_checkout),
          ...
          "1" === wc_checkout_params.is_checkout &&
            g(document.body).trigger("init_checkout"),
          "yes" === wc_checkout_params.option_guest_checkout &&
            g("input#createaccount")
      ...
      init_payment_methods: function () {
        ...
        1 === e.length && e.eq(0).hide(),
          v.selectedPaymentMethod &&
            g("#" + v.selectedPaymentMethod).prop("checked", !0),
      ...
      payment_method_selected: function (e) {
        if (
          ...
          o &&
            !t.is(":visible") &&
            (g("div.payment_box").filter(":visible").slideUp(230),
            o && t.slideDown(230));
        } else g("div.payment_box").show();
        g(this).data("order_button_text")
          ? g("#place_order").text(g(this).data("order_button_text"))
          : g("#place_order").text(g("#place_order").data("value"));
        var c = g(
          '.woocommerce-checkout input[name="payment_method"]:checked'
        ).attr("id");
        c !== v.selectedPaymentMethod &&
          g(document.body).trigger("payment_method_selected"),
          (v.selectedPaymentMethod = c);
      },
      toggle_create_account: function () {
        g("div.create-account").hide(),
          g(this).is(":checked") &&
            (g("#account_password").val("").change(),
                ...
                if (e && !0 === e.reload) window.location.reload();
                  ...
                  if (
                    (g(".payment_box :input").each(function () {
                      ...
                      e &&
                        (-1 !==
                        g.inArray(g(this).attr("type"), ["checkbox", "radio"])
                          ? (o[e] = g(this).prop("checked"))
                          : (o[e] = g(this).val()));
                    }),
                    e &&
                      e.fragments &&
                      (g.each(e.fragments, function (e, t) {
                        (v.fragments && v.fragments[e] === t) ||
                          g(e).replaceWith(t),
                          g(e).unblock();
                      }),
        ...
        return (
          o.is(".processing") ||
            (!1 !== o.triggerHandler("checkout_place_order") &&
              !1 !==
                o.triggerHandler(
                  "checkout_place_order_" + v.get_payment_method()
                ) &&
              ...
              g.ajax({
                ...
                success: function (e) {
                  ...
                  try {
                    if (
                      "success" !== e.result ||
                      !1 === o.triggerHandler("checkout_place_order_success")
                    )
                      throw "failure" === e.result
                        ? "Result failure"
                        : "Invalid response";
                ...
                error: function (e, t, o) {
                  v.detachUnloadEventsOnSubmit(),
                    v.submit_error(
                      '<div class="woocommerce-error">' + o + "</div>"
                    );
                },
              }))),
          !1
            ...
            success: function (e) {
              g(".woocommerce-error, .woocommerce-message").remove(),
                ...
                e &&
                  (t.before(e),
                  t.slideUp(),
                  g(document.body).trigger("applied_coupon_in_checkout", [
                    o.coupon_code,
                  ]),
                  g(document.body).trigger("update_checkout", {
        ...
        g.ajax({
          ...
          success: function (e) {
            g(".woocommerce-error, .woocommerce-message").remove(),
              t.removeClass("processing").unblock(),
              e &&
                (g("form.woocommerce-checkout").before(e),
                g(document.body).trigger("update_checkout", {
                  update_shipping_method: !1,
                }),
                g("form.checkout_coupon")
          ...
          return (
            g(".woocommerce-terms-and-conditions").slideToggle(function () {
              ...
              g(".woocommerce-terms-and-conditions").is(":visible")
                ? (e.addClass("woocommerce-terms-and-conditions-link--open"),
                  e.removeClass(
                    "woocommerce-terms-and-conditions-link--closed"
                  ))
                : (e.removeClass("woocommerce-terms-and-conditions-link--open"),
